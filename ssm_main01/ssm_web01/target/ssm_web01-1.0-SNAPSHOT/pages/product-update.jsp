			...
			<form action="${pageContext.request.contextPath}/product/update"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<%--定义了var属性后不会在页面打印出来,会把数据放入请求域 --%>
						<fmt:formatDate var="data" value="${product.departureTime}" pattern="yyyy-MM-dd HH:mm" />
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="产品价格"
								name="productPrice" value="<fmt:formatNumber value="${product.productPrice}"  pattern="0.00"/>">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="productStatus">
								<option value="0" selected='${product.productStatus}==0?"selected":""'>关闭</option>
								<option value="1" selected='${product.productStatus}==1?"selected":""'>开启</option>
							</select>
						</div>
